// Renamed to cacheStore so that it is clearer
const cacheStore = {}
...
const { get, set, timeTillExpires, remove } = useNamespace(defaultNamespace)

// We don't expose removeAll on the defaultNamespace.
// We only allow remove all on custom namespaces
export { get, set, timeTillExpires, remove, useNamespace }
